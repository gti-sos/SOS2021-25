...
evictionAPI.register(app);
salesAPI.register(app);
...
app.use("/proxyRentals", function(req, res) {
	var apiServerHost = 'https://sos2021-09.herokuapp.com/api/v2/cut-off-marks-by-degrees-us/cuts';
